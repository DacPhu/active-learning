...
def get_base_AL_mapping():
  from libraries.google_active_learning import (
      HierarchicalClusterAL, InformativeClusterDiverseSampler,
      RepresentativeClusterMeanSampling, UniformSampling)
  from libraries.google_active_learning.sampling_methods.graph_density import \
      GraphDensitySampler
  from libraries.google_active_learning.sampling_methods.kcenter_greedy import \
      kCenterGreedy
  from libraries.google_active_learning.sampling_methods.margin_AL import \
      MarginAL
...
def get_all_possible_arms():
  from libraries.google_active_learning.sampling_methods.mixture_of_samplers import \
      MixtureOfSamplers
  AL_MAPPING['mixture_of_samplers'] = MixtureOfSamplers


def get_wrapper_AL_mapping():
  from libraries.google_active_learning import BanditDiscreteSampler
  from libraries.google_active_learning.sampling_methods.simulate_batch import \
