...
def get_base_AL_mapping():
  ...
  from src.core.sampling_methods.margin_AL import MarginAL
  from src.core.sampling_methods.represent_cluster_centers import \
      RepresentativeClusterMeanSampling
  from src.core.sampling_methods.uniform_sampling import UniformSampling
...
def get_all_possible_arms():
  from src.core.sampling_methods.mixture_of_samplers import MixtureOfSamplers
  AL_MAPPING['mixture_of_samplers'] = MixtureOfSamplers


def get_wrapper_AL_mapping():
  from src.core.sampling_methods.bandit_discrete import BanditDiscreteSampler
  from src.core.sampling_methods.simulate_batch import SimulateBatchSampler
